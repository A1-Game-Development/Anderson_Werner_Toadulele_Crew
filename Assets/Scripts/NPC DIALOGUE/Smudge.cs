...
public class Smudge : NPCBase
{
    ...
    void LoadDialogue()
    {
        TextAsset textFile = Resources.Load<TextAsset>("Smudge");
    ...
    void StartDialogue()
    {
        ...
        currentLines = isPacified
            ? dialogueLines["Pacified"]
            : dialogueLines["Introduction"];
